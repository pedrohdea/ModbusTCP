#include "libs/crc16.h"  // biblioteca CRC-16 Modbus
Crc16 crc;

#define LED_STATUS 13
#define BAUDRATE 9600

#define RS485_ENABLE 2  // controle de direção RS-485

#define END_FRAME_TIME (3.5 * 11 * 1000) / BAUDRATE + 1

#define PIN_BIT0 6  // LSB
#define PIN_BIT1 7  // MSB
...
void setup() {
  ...
  endereco_escravo = (bit1 << 1) | bit0;  // combina os bits: 00, 01, 10, 11
  endereco_escravo += 1;  // agora vai de 1 a 4
